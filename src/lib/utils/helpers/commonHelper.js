...
export function getCurrentEpochCycle(epochStartTime, epochLength) {
...
export function openModal(modalId) {
    const modalCheckboxInput = document.getElementById(modalId);
 ...
 */
export function inputAmountInValidMessage(amount) {
 ...
 */
export function minifyAddress(address = '0x0000000000000000000000000000000000000000', first = 6, last = 4) {
