...
<div class="flex w-full flex-col gap-4">
	<div class="mb-2 flex flex-col items-start justify-center">
		<div class="flex items-center justify-center gap-1">
			<span class="font-poppins text-2xl font-medium text-grey-800"> Stake </span>
				...
				class={cn(
					{
						...
						'bg-base-100': $kalypsoStore.activeStakeTab !== 'add'
					},
				...
				class={cn(
					{
						...
						'bg-base-100': $kalypsoStore.activeStakeTab !== 'withdraw'
					},
