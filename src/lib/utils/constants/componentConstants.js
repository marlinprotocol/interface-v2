...
export const getColorClassByVariant = (variant) => {
    switch (variant) {
        case 'success':
...
export const getTextColorClassByVariant = (variant) => {
    switch (variant) {
        case 'primary':
            return 'text-primary';
        case 'secondary':
...
export const getImageClassByVariant = (variant) => {
    switch (variant) {
        case 'primary':
            return 'primary-img';
        case 'info':
...
export const getImagebyWalletProvider = (walletProvider) => {
