...
const Copy = '/images/copyicon.svg';
const CopyGrey = '/images/copy-btn.svg';
const Cycle = '/images/cycleimg.svg';
const CycleLoader = '/images/cycleloader.svg';
const History = '/images/historyicon.svg';
const Info = '/images/info.svg';
const LeftBlueArrow = '/images/left-blue-arrow.svg';
const Lock = '/images/lockicon.svg';
...
const UnActiveTick = '/images/unactivetick.svg';
...
const marlinLgLogoDark = '/images/marlinLgLogoDark.svg';
