const baseFilledButtonClasses =
	'btn btn-theme btn-sm items-center flex justify-center disabled:cursor-not-allowed';
...
export const buttonClasses = {
	...
	tableConvertButton:
		'btn btn-xs text-xs h-[35px] w-[126px] rounded btn-primary disabled:bg-primary disabled:bg-opacity-60 disabled:text-white disabled:cursor-not-allowed',
	paginationButton:
...
export const inputClasses = {
	inputText:
		'input input-ghost h-[30px] w-full text-lg p-0 font-semibold text-primary disabled:opacity-70 disabled:text-primary disabled:placeholder:text-primary/[.2] focus-within:text-primary placeholder:text-primary/[.2] focus:outline-none focus-within:border-b-2 focus:bg-transparent',
	searchInputText:
		'input input-ghost h-[30px] w-full text-[15px] p-0 font-normal text-primary focus:outline-none focus-within:border-b-2 focus-within:text-primary focus:bg-transparent disabled:text-blue-500 placeholder:text-black/[.2]'
};
