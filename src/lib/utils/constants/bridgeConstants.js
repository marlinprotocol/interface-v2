...
export const kPondToMPondTableHeader = [
    {
        title: 'DATE',
        id: 'date',
        sorting: true
    ...
    },
    {
        title: 'MPond',
        id: 'mPond',
        tooltipText: 'The corresponding amount of MPond received as a result of the conversion from POND. Note: 1 Million POND equals 1 MPond.'
    },
    {
        title: 'TX HASH',
        id: 'txnHash',
...
export const kMPondToPondTableHeader = [
    {
        title: 'DATE',
        id: 'date',
        sorting: true
    ...
    },
    {
        title: 'TOTAL POND',
        id: 'pond',
        tooltipText: 'The total amount of POND to be received as a result of the conversion from MPond. Note: 1 MPond equals 1 Million POND.'
    },
    {
        title: 'PENDING',
        id: 'pending',
...
export const kMPondConversionHistoryTableHeader = [
    {
        title: 'DATE',
        id: 'date'
    },
...
export const kMPondConversionCycleTableHeader = [
    {
...
//# sourceMappingURL=bridgeConstants.js.map